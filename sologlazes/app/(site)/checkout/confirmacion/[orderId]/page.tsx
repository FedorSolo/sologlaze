  ...
  return (
    <div className="container flex flex-col items-center gap-4 py-24 text-center">
      ...
      <p className="text-text-secondary">
        Número de pedido <span className="font-medium text-text-primary">{orderId}</span>
      </p>
      <p className="max-w-sm text-sm text-text-secondary">
        Te enviamos un email de confirmación. Podés seguir el estado desde tu cuenta.
      </p>
      <div className="mt-4 flex gap-3">
        <Link href={`/cuenta/pedidos/${orderId}`} className="rounded-full bg-accent px-6 py-3 text-sm text-white">
          Ver mi pedido
        </Link>
