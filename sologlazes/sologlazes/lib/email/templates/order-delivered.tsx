...
export function OrderDeliveredEmail({ orderId, customerName }: Props) {
  return (
    <html>
          ...
          <tbody>
            <tr>
              <td style={{ padding: "32px" }}>
                ...
                <h1 style={{ fontSize: 22, margin: "0 0 16px" }}>¡Tu pedido llegó, {customerName}!</h1>
                <p style={{ fontSize: 14, color: "#6B6153", lineHeight: 1.6 }}>
                  Confirmamos la entrega del pedido <strong>{orderId}</strong>. Esperamos que tus esmaltes den
                  el resultado que buscabas — contanos cómo salió, nos encanta ver las piezas terminadas.
                </p>
                <a
